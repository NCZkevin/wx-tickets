...
$(function () {
    ...
    var courseDetail = {
        ...
        events:{
            ...
            '.edit':{
                click:function(e){
                    var matic=document.getElementsByClassName('va');
                    matic.attr("disabled",true);
                }
            }
        }
    };
    ...
    var timeNum = {
        name: 'timeNum',
        url: '#timeNum',
        template: '#tpl_timeNum'
    };
    var addCourse = {
        name: 'addCourse',
        url: '#addCourse',
        template: '#tpl_addCourse',
        events:{
            '.js_addcourse':{
                click:function(e){
                    var id=$(this).data('id');
